    ...
    def run(self):
        ...
        for param in range(-1, self._n_params):
            ...
            if param == -1:
                ...
                self._ground_state = qt.Qobj(circuit_state) #quantum state generated by circuit
                energy = qt.expect(self._H, self._ground_state)
                ...
                overlap = self._ground_state.overlap(self._H * circuit_state)
